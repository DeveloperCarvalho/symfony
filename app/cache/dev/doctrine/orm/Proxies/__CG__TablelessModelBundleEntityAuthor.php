 ...
 */
class Author extends \Tableless\ModelBundle\Entity\Author implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Tableless\\ModelBundle\\Entity\\Author' . "\0" . 'id', '' . "\0" . 'Tableless\\ModelBundle\\Entity\\Author' . "\0" . 'name', '' . "\0" . 'Tableless\\ModelBundle\\Entity\\Author' . "\0" . 'post');
        }
