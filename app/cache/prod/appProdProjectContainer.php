...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'novo_sy', 'user' => 'root', 'password' => 1234, 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Tableless/ModelBundle/Entity'))), 'Tableless\\ModelBundle\\Entity');
        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('TablelessModelBundle' => 'Tableless\\ModelBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_843fb597ebe3f64aa4cf9777a9489d7e88b39a6b856a7466f0a8431e66865d55');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Tableless/CoreBundle/Resources/views'), 'TablelessCore');
        $instance->addPath(($this->targetDirs[3].'/src/Tableless/ModelBundle/Resources/views'), 'TablelessModel');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('562644a2d9a881.98111658')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TablelessCoreBundle' => 'Tableless\\CoreBundle\\TablelessCoreBundle',
                'TablelessModelBundle' => 'Tableless\\ModelBundle\\TablelessModelBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appProdProjectContainer',
            'database_host' => 'localhost',
            'database_port' => NULL,
            'database_name' => 'novo_sy',
            'database_user' => 'root',
